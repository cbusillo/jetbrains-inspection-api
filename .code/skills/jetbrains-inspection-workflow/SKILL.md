...
6. For verdict or extraction changes that must prove the red lane, run
   ...
   For 2026.2 release gates, pass `--ide-channel stable --ide-version 2026.2`
   and use `--timeout-ms 300000 --prepare-timeout-ms 300000`; this matches the
   plugin wait cap and avoids treating a slow compatibility inspection as release evidence.
